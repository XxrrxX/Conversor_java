...
int cont = 0;
    try{
    while(cont == 0){
        String divisa1 =(JOptionPane.showInputDialog(null,"Seecciona divisa a convertir","Menu",JOptionPane.PLAIN_MESSAGE,null,new Object[] {"MXN","USD","EUR","CAD","ARS","BRL","CNY","COP","CLP","CUP"},"Seleciona")).toString();
        try{
